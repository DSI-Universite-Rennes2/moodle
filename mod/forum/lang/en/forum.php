...
$string['bynameondate'] = 'by {$a->name}{$a->roles} - {$a->date}';
...
$string['configshowroles'] = 'Show role names, if selected, behind autor name on each discussion headers.';
...
$string['showroles'] = 'Show user roles';
