...
Bobby,Bunce,,"Moodle HQ","Rock on!",student5@example.com,75.00,,75.00,{exportdate}';
    ...
    public function test_update_grade_item() {
        ...
        $newgrades = $testobject->test_update_grade_item($this->courseid, $map, $key, $verbosescales, $testarray[0][6], $linenumber);
        ...
        $a = array('badgrade' => $value, 'linenumber' => $linenumber);
        $expectederrormessage = get_string('badgrade', 'gradeimport_csv', $a);
