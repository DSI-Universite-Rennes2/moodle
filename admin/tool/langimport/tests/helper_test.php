...
require_once('admin/tool/langimport/lib.php');
...
class helper_testcase extends \advanced_testcase {
    ...
    public function test_check_locale_availability() {
        ...
        $MOCK = array(); // Emulate responses from PHP native functions called in helper::check_locale_availability().
        ...
        $result = helper::check_locale_availability('en');
        ...
        foreach (array(1, true, '') as $invalidparameter) {
            try {
                $result = helper::check_locale_availability($invalidparameter);
