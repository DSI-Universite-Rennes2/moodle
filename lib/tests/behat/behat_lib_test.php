...
class behat_lib_test extends advanced_testcase {
    ...
    public function url_provider() {
        return [
            ...
            array('http://behat.moodle.org', true, array('behat.moodle.org', 80, '')),
            array('https://behat.moodle.org', true, array('behat.moodle.org', 443, '')),

            // Test for custom port.
            array('http://behat.moodle.org:8080', true, array('behat.moodle.org', 8080, '')),

            // Test for url with path.
            array('http://behat.moodle.org/behat', true, array('behat.moodle.org', 80, '/behat')),

            // Test for url that does not match with environment.
            array('http://behat.moodle.org', false, array('moodle.org', 80, '')),
        ];
    }
}
